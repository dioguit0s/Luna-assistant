...
Esse descarte é absoluto em toda tool que aciona algo. A única exceção do repositório é `list_devices`, somente leitura: por não acionar nada, ela valida o `room_id` do modelo contra o registro e o usa quando existe — ver [ADR 009](009-inventario-por-comodo.md).
